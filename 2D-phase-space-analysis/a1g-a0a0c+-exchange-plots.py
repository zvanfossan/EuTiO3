...
psm = ax[0][0].pcolormesh(j1xy_matrix, cmap='viridis', rasterized=True, vmin=-1e-5, vmax=1.1e-5)
...
psm = ax[0][1].pcolormesh(j1z_matrix, cmap='viridis', rasterized=True, vmin=-1e-5, vmax=1.1e-5)
...
psm = ax[1][0].pcolormesh(j2xy_matrix, cmap='viridis', rasterized=True, vmin=-8e-6, vmax=-5.25e-6)
...
psm = ax[1][1].pcolormesh(j2z_matrix, cmap='viridis', rasterized=True, vmin=-8e-6, vmax=-5.25e-6)

...
df = df.drop(labels=['4_atom_5','4_atom_2'], axis=0) #drop specific configurations from dataset
nearest_neigbors_df = nearest_neigbors_df.drop(labels=[8,11],axis=0) #drop specific configurations from dataset
print(df)
